...
function Home(props) {
  ...
  return (
    ...
    <section className=" h-screen bg-[url('https://i.postimg.cc/sgH5hBXW/bg.jpg')]  w-full   bg-center bg-cover  flex items-center  ">

      <div className="max-w-[1200px] w-full text-black mx-auto my-0">
